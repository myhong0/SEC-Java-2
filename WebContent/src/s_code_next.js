...
//micro site일때 자동 Exit Link track 하지 않음 
	  ...
	  /* SEC B2B, CN Store */
s.linkInternalFilters="JAVA-SCRIPT:,tel:,samsungshop.com.cn,www.samsungb2b.co.kr,www.samsung.com,japan.samsung.com,2.samsung.com,3.samsung.com,4.samsung.com,shop.samsung.com,store.samsung.com,local.sec.samsung.com,ru.samsung.com,eu.samsung.com"; 
...
function getdil_Local_Account(){
	...
	var useDilCountry =  ['sa','sa_en','uk','ae','ae_ar','fr','de','it','au','se','fi','no','dk','pl','nl','be','be_fr','id','th','tr'/*'ru'*/];
	var useDilYNCountry = "";
