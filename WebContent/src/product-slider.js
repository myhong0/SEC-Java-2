(function ($) {
	ss.ProductSlider = function( $container ){
		...
		function fnListSize(m){
			...
			var objWidth = listItems.eq(0).width();
		...
		if ( $('html').hasClass('touch') ){
			...
			if ( chkWidth < 767 )
			{
				...
				fnSwipeMovement('recopick',recopickCounter,'recopick_list');
				fnSwipeMovement('store_pick',storepickCounter,'storepick_list');
