...
(function (window, $) {
	...
	ss.Sign = function () {
		...
		function updateAgreePolicy()
		{
			...
			}else if (SITE_CD == 'de' /*|| SITE_CD == 'fr'*/) { //DE hybris6.0  //FR Hybris 6.0
				setAgreeStorePolicyUrl = "https://" + STORE_DOMAIN + "/" + SITE_CD + "/ng/p4v1/agreeStorePolicy?receiveEmail=" + receiveEmailChecked;
			}else if (SITE_CD == 'nl') {
				setAgreeStorePolicyUrl = "https://" + STORE_DOMAIN + "/" + SITE_CD + "/ng/p4v1/setAgreeStorePolicy?receiveEmail=" + receiveEmailChecked;
			}else {
			...
			if (token || snsToken)
			{
				if (validate)
				{
					...
					if (USE_ESTORE)
					{
						...
						}else if (SITE_CD == 'de' /*|| SITE_CD == 'fr'*/) { //DE Hybris 6.0  //FR Hybris 6.0
							sessionCheckUrl = "https://" + STORE_DOMAIN + "/" + SITE_CD + "/ng/p4v1/sessionCheck";
						}else {
		...
		ss.Auth.signOut = function(goUrl)
		{
			...
			if (USE_ESTORE && estoreLive){
				...
				} else if (SITE_CD == 'au' || SITE_CD == 'de' /*|| SITE_CD == 'fr'*/){ 
		...
		ss.Auth.getGlobalCartCount = function(callback) {
			...
			function setGlobalCartCount( result ) {
				if( result ) {
					if (result.resultCode == '0000') {
						//AU Hybris 6.0  //DE Hybris 6.0  //FR Hybris 6.0
						if ( ($('#gnbP5UseSite').val() == 'true') && window.smg.aem) {
			...
			ss.Auth.checkSignIn(function(isLogedIn) {
			    ...
			    else
			    {
					...
					if(SITE_CD == 'br' || SITE_CD == 'au' || SITE_CD == 'de' /*|| SITE_CD == 'fr'*/){ //AU Hybris 6.0  //DE Hybris 6.0  //FR Hybris 6.0
						addCartCookie = "Y";
					}
			    	if (addCartCookie == "Y")
			    	{
				...
				if (USE_ESTORE)
				{
					...
					if (!exceptionReferrerDomain)
					{
						...
						nextGenLoginResult = function(data)
						{
						    ...
						    if ((data.hasAddInfo == false && (SITE_CD == 'au' /*|| SITE_CD == 'fr'*/)) || (data.hasaddinfo == "N" && (SITE_CD != 'sec' && SITE_CD != 'cn' && SITE_CD != 'de')))
						...
						//#1698:login remove
						} else if( SITE_CD == 'sec' || SITE_CD == 'es' || SITE_CD == 'se' || SITE_CD == 'de' || SITE_CD == 'it' || SITE_CD == 'fr' || SITE_CD == 'nl' || SITE_CD == 'nz' || SITE_CD == 'au'){ 
							try {
